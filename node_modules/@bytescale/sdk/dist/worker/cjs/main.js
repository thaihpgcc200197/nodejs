...
function UploadManagerBrowserWorkerBase_typeof(o) { "@babel/helpers - typeof"; return UploadManagerBrowserWorkerBase_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, UploadManagerBrowserWorkerBase_typeof(o); }
...
function UploadManagerBrowserWorkerBase_toPropertyKey(t) { var i = UploadManagerBrowserWorkerBase_toPrimitive(t, "string"); return "symbol" == UploadManagerBrowserWorkerBase_typeof(i) ? i : i + ""; }
function UploadManagerBrowserWorkerBase_toPrimitive(t, r) { if ("object" != UploadManagerBrowserWorkerBase_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != UploadManagerBrowserWorkerBase_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function UploadManagerBrowserWorkerBase_callSuper(t, o, e) { return o = UploadManagerBrowserWorkerBase_getPrototypeOf(o), UploadManagerBrowserWorkerBase_possibleConstructorReturn(t, UploadManagerBrowserWorkerBase_isNativeReflectConstruct() ? Reflect.construct(o, e || [], UploadManagerBrowserWorkerBase_getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function UploadManagerBrowserWorkerBase_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (UploadManagerBrowserWorkerBase_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var UploadManagerBrowserWorkerBase = /*#__PURE__*/function (_UploadManagerBase) {
  function UploadManagerBrowserWorkerBase() {
    ...
    return UploadManagerBrowserWorkerBase_callSuper(this, UploadManagerBrowserWorkerBase, arguments);
  }
  UploadManagerBrowserWorkerBase_inherits(UploadManagerBrowserWorkerBase, _UploadManagerBase);
  return UploadManagerBrowserWorkerBase_createClass(UploadManagerBrowserWorkerBase, [{
...
function UploadManagerWorker_typeof(o) { "@babel/helpers - typeof"; return UploadManagerWorker_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, UploadManagerWorker_typeof(o); }
...
function UploadManagerWorker_toPropertyKey(t) { var i = UploadManagerWorker_toPrimitive(t, "string"); return "symbol" == UploadManagerWorker_typeof(i) ? i : i + ""; }
function UploadManagerWorker_toPrimitive(t, r) { if ("object" != UploadManagerWorker_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != UploadManagerWorker_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function UploadManagerWorker_callSuper(t, o, e) { return o = UploadManagerWorker_getPrototypeOf(o), UploadManagerWorker_possibleConstructorReturn(t, UploadManagerWorker_isNativeReflectConstruct() ? Reflect.construct(o, e || [], UploadManagerWorker_getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function UploadManagerWorker_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (UploadManagerWorker_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var UploadManager = /*#__PURE__*/function (_UploadManagerBrowser) {
  function UploadManager() {
    ...
    return UploadManagerWorker_callSuper(this, UploadManager, arguments);
  }
  UploadManagerWorker_inherits(UploadManager, _UploadManagerBrowser);
  return UploadManagerWorker_createClass(UploadManager, [{
    key: "doPutUploadPart",
    value: function doPutUploadPart(part, contentLength, source, _onProgress, addCancellationHandler) {
      try {
        var _this = this;
        return UploadManagerWorker_await(UploadManagerFetchUtils.doPutUploadPart(_this.config, part, _this.getRequestBody(part, source), contentLength, addCancellationHandler));
      } catch (e) {
        return Promise.reject(e);
      }
    }
