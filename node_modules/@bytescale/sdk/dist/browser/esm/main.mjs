...
function UploadManagerBrowser_typeof(o) { "@babel/helpers - typeof"; return UploadManagerBrowser_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, UploadManagerBrowser_typeof(o); }
...
function UploadManagerBrowser_toPropertyKey(t) { var i = UploadManagerBrowser_toPrimitive(t, "string"); return "symbol" == UploadManagerBrowser_typeof(i) ? i : i + ""; }
function UploadManagerBrowser_toPrimitive(t, r) { if ("object" != UploadManagerBrowser_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != UploadManagerBrowser_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function UploadManagerBrowser_callSuper(t, o, e) { return o = UploadManagerBrowser_getPrototypeOf(o), UploadManagerBrowser_possibleConstructorReturn(t, UploadManagerBrowser_isNativeReflectConstruct() ? Reflect.construct(o, e || [], UploadManagerBrowser_getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function UploadManagerBrowser_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (UploadManagerBrowser_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var UploadManager = /*#__PURE__*/function (_UploadManagerBrowser) {
  function UploadManager() {
    ...
    return UploadManagerBrowser_callSuper(this, UploadManager, arguments);
  }
  UploadManagerBrowser_inherits(UploadManager, _UploadManagerBrowser);
  return UploadManagerBrowser_createClass(UploadManager, [{
    key: "doPutUploadPart",
...
var ServiceWorkerUtils = /*#__PURE__*/function () {
  ...
  return ServiceWorkerUtils_createClass(ServiceWorkerUtils, [{
